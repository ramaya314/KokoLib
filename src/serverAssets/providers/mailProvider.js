...
var mailProvider = function (options) {

  var module = {};

  module.sendDefaultContactMail = function(message, transporter, onSuccess, onError) {
    this.sendMail(message, transporter, defaultMailTemplate, onSuccess, onError);
  }

  module.sendMail = function(message, transporter, template, onSuccess, onError) {
